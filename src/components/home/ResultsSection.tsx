    ...
    <section className="border-y border-black/10 bg-[#e9e8e3] text-black">
      <div className="mx-auto max-w-7xl px-5 py-20 sm:px-6 md:px-10 lg:py-28">
        ...
        <div className="mt-4 grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-end">
          <h2 className="text-[2.75rem] font-black uppercase leading-[0.88] tracking-[-0.06em] sm:text-6xl lg:text-7xl">
            {en ? (
          ...
          <div>
            ...
            <Link
              ...
              className="mt-7 inline-flex min-h-13 w-full items-center justify-center sm:w-auto bg-black px-7 text-sm font-black uppercase tracking-[0.1em] text-white transition hover:bg-black/80"
            >
        ...
        <div className="mt-12 grid gap-px overflow-hidden border border-black/15 bg-black/15 md:grid-cols-3">
          {features.map(([eyebrow, title, text]) => (
            <article key={title} className="bg-[#e9e8e3] p-6 sm:p-7 md:p-8">
              <p className="text-[10px] font-black uppercase tracking-[0.22em] text-black/35">
                {eyebrow}
              </p>
              <h3 className="mt-6 text-2xl font-black uppercase sm:mt-8 tracking-[-0.04em]">
                {title}
              </h3>
