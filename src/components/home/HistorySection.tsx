      ...
      <div className="mx-auto max-w-7xl px-5 py-20 sm:px-6 md:px-10 md:py-24 lg:py-32">
        <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-center lg:gap-14">
          <div>
            ...
            <p className="mt-4 text-[clamp(6rem,17vw,13rem)] font-black leading-[0.72] tracking-[-0.09em] text-white/10">
              {event.stats.since}
            </p>
          </div>
        ...
        <div className="mt-12 grid gap-px sm:mt-14 lg:mt-16 overflow-hidden border border-white/10 bg-white/10 sm:grid-cols-2 lg:grid-cols-4">
          {milestones.map((item) => (
