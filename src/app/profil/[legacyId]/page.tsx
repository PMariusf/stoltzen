...
export async function generateMetadata({
  ...
  return {
    title: `${profile.name} – StoltzeProfil`,
    description: `Resultathistorikk og personbeste for ${profile.name} i Stoltzekleiven Opp.`,
  };
}
...
export default async function ProfilePage({ params }: PageProps) {
  ...
  return <RunnerProfile profile={profile} locale="no" />;
}
